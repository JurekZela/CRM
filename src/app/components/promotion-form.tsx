...
export default function PromotionForm({
  ...
  const { mutateAsync, isPending } = useMutation({
    ...
    onSuccess: (data) => {
      queryClient.setQueryData<Array<PromotionFieldValues>>(['promotions', companyId], (oldData) => {
        return oldData ? [...oldData, data] : [data];
      });

      queryClient.setQueryData<Array<PromotionFieldValues>>(['promotions'], (oldData) => {
        return oldData ? [...oldData, data] : [data];
      });
    }
  });
